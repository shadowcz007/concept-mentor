...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-soft hover:bg-primary/90 hover:shadow-card active:scale-95",
        ...
        hero: "bg-gradient-primary text-primary-foreground shadow-glow hover:shadow-card hover:scale-105 active:scale-95 font-semibold",
        floating: "bg-card border border-border shadow-card hover:shadow-glow hover:scale-105 active:scale-95"
      },
      size: {
